...
class CharacterControllerTest : public CharacterBaseTest, public CharacterContactListener
{
public:
	JPH_DECLARE_RTTI_VIRTUAL(CharacterControllerTest)
...
protected:
	...
	virtual RVec3			GetCharacterPosition() const override { return mCharacterController->GetPosition(); }
...
private:
	...
	Ref<CharacterController>	mCharacterController;
